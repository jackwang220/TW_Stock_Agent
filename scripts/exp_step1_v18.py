"""Step1 v18(259檔擴充universe) — 族群「超額」動能(鄰居報酬 − 大盤報酬)接進 H,回測 vs 原始族群動能 vs plain H。
...
def main():
    ...
    L = ["# Step1 v18(259檔擴充universe) — 族群『超額』動能(−大盤)接進 H vs 原始族群 vs plain H\n",
    ...
    REPORT = ROOT / "reports" / "exp_step1_v18.md"
